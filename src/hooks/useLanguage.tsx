...
const translations = {
  ru: {
    ...
    'sync_history_desc': 'Успешные и неудачные попытки отправки задач в облако с временем и причинами ошибок',
    'sync_history_empty': 'Пока нет попыток синхронизации',
    'sync_success': 'Успешно',
    'sync_failed': 'С ошибкой',
    'sync_sent_at': 'Отправлено',
    'sync_last_attempt': 'Последняя попытка',
    'sync_attempt': 'Попытка',
    'sync_attempt_count': 'Количество попыток',
    'sync_result': 'Результат',
    'sync_result_success': 'Отправлено успешно',
    'sync_result_failed_retry_scheduled': 'Не отправлено, повтор запланирован',
    'sync_result_failed_retry_ready': 'Не отправлено, можно повторить сейчас',
    'sync_result_failed_not_queued': 'Не отправлено, изменение больше не ожидает отправки',
    'sync_reason': 'Причина',
    'sync_retry_now': 'Повторить сейчас',
    'sync_nothing_to_retry': 'Нет изменений, ожидающих отправки',
    'sync_already_running': 'Синхронизация уже выполняется',
    'sync_clear_history': 'Очистить историю',
    ...
    'sync_technical_details': 'Технические детали',
    'sync_next_retry': 'Следующая попытка',
    'sync_retry_count': 'Количество попыток',
    'sync_full_error': 'Полный текст ошибки',
    'sync_no_retry': 'Не запланирована',
    'sync_completed': 'Отправка завершена',
    ...
    'seo_auth_register_title': 'Регистрация — Todo List',
    'seo_auth_login_desc': 'Войдите в аккаунт, чтобы управлять вашими задачами.',
    'seo_auth_register_desc': 'Создайте аккаунт, чтобы начать работу с менеджером задач.',
    'seo_favorites_title': 'Избранные задачи — Todo List',
    'seo_favorites_desc': 'Часто используемые задачи и шаблоны для быстрого добавления.',
    'seo_archive_title': 'Архив задач — Todo List',
    'seo_archive_desc': 'Список завершённых и архивных задач с возможностью восстановления.',
    'seo_profile_title': 'Профиль — Todo List',
    'seo_profile_desc': 'Настройки профиля: измените имя, загрузите аватар и выберите язык интерфейса.',
  },
  en: {
    // Common
    'loading': 'Loading...',
    ...
    'sync_history_desc': 'Successful and failed attempts to send tasks to the cloud, with times and clear error reasons',
    'sync_history_empty': 'No sync attempts yet',
    'sync_success': 'Successful',
    'sync_failed': 'Failed',
    'sync_sent_at': 'Sent at',
    'sync_last_attempt': 'Last attempt',
    'sync_attempt': 'Attempt',
    'sync_attempt_count': 'Attempt count',
    'sync_result': 'Result',
    'sync_result_success': 'Sent successfully',
    'sync_result_failed_retry_scheduled': 'Not sent, retry scheduled',
    'sync_result_failed_retry_ready': 'Not sent, ready to retry now',
    'sync_result_failed_not_queued': 'Not sent, this change is no longer queued',
    'sync_reason': 'Reason',
    'sync_retry_now': 'Retry now',
    'sync_nothing_to_retry': 'There are no changes waiting to be sent',
    'sync_already_running': 'Sync is already in progress',
    ...
    'sync_next_retry': 'Next attempt',
    'sync_retry_count': 'Attempt count',
    'sync_full_error': 'Full error text',
    'sync_no_retry': 'Not scheduled',
    'sync_completed': 'Sending completed',
    ...
    'seo_auth_register_title': 'Sign up — Todo List',
    'seo_auth_login_desc': 'Sign in to your account to manage your tasks.',
    'seo_auth_register_desc': 'Create an account to start using the task manager.',
    'seo_favorites_title': 'Favorite tasks — Todo List',
    'seo_favorites_desc': 'Frequently used tasks and templates for quick adding.',
    'seo_archive_title': 'Task archive — Todo List',
    'seo_archive_desc': 'Completed and archived tasks with the option to restore them.',
    'seo_profile_title': 'Profile — Todo List',
    'seo_profile_desc': 'Profile settings: change your name, upload an avatar and pick the interface language.',
  },
};
